...
export default function ConfigAuditEmbed() {
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="glass-panel border-b border-white/5 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-sm font-semibold text-white">Configurations Audit</h1>
              <p className="text-xs text-[#00d4ff]">Embedded View</p>
            </div>
          </div>
          <Button
            asChild
          ...
          >
            <a href={CONFIG_AUDIT_URL} target="_blank" rel="noopener noreferrer">
      ...
      <div className="flex-1 relative">
        ...
        {isLoading && !loadFailed && (
          <div className="absolute inset-0 flex items-center justify-center bg-background z-10">
            ...
            >
              ...
              <div>
                <p className="text-white font-medium">Loading Configurations Audit...</p>
        ...
        {loadFailed && (
          ...
          >
            <div className="glass-panel cyber-border rounded-lg p-8 max-w-md text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-[#888899]">
                  The Configurations Audit app has security policies that prevent embedding.
